...
class HybridTaskCascadeRoIHead(CascadeRoIHead):
    ...
    def _mask_forward_train(self,
        ...
        # semantic feature fusion element-wise sum for original features and pooled semantic features
        if self.with_semantic and 'mask' in self.semantic_fusion:
        ...
        # mask information flow forward all previous mask heads to obtain last_feat, and fuse it with the normal mask feature
        if self.mask_info_flow:
            last_feat = None
